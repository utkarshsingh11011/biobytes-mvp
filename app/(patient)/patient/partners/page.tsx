  ...
  const partners = [
    {
      ...
      description: "Directly sync your test results into BioBytes. No more manual uploads.",
    ...
    },
    {
      ...
      description: "Order medicines based on your BioBytes health alerts and doctor prescriptions.",
