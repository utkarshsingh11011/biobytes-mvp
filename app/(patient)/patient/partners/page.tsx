  ...
  const partners = [
    {
      ...
      description: "Directly sync your test results into E-Health Tracker. No more manual uploads.",
    ...
    },
    {
      ...
      description: "Order medicines based on your E-Health Tracker health alerts and doctor prescriptions.",
