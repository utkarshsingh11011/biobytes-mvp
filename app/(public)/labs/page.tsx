      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Book your next diagnostic test through BioBytes and have your reports automatically synchronized to your health dashboard.
          </p>
        </div>
          ...
          {labs.map(lab => (
            <Card key={lab.id} className="hover:shadow-lg transition-all duration-300">
              <CardHeader className="text-center">
                ...
                <CardDescription>Verified BioBytes Partner</CardDescription>
              </CardHeader>
