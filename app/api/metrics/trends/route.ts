...
export async function GET(req: Request) {
  ...
  healthRecords.forEach(hr => {
    ...
    if (hr.hemoglobin !== null) {
      ...
      trendsByBiomarker["HEMOGLOBIN"].data.push({ date: dateStr, value: hr.hemoglobin, isAbnormal: false, labName })
    }
    if (hr.fasting_blood_sugar !== null) {
      ...
      trendsByBiomarker["FASTING_SUGAR"].data.push({ date: dateStr, value: hr.fasting_blood_sugar, isAbnormal: false, labName })
    }
    if (hr.thyroid_tsh !== null) {
      ...
      trendsByBiomarker["TSH"].data.push({ date: dateStr, value: hr.thyroid_tsh, isAbnormal: false, labName })
    }
    if (hr.ldl_cholesterol !== null) {
      ...
      trendsByBiomarker["LDL"].data.push({ date: dateStr, value: hr.ldl_cholesterol, isAbnormal: false, labName })
    }
    if (hr.hdl_cholesterol !== null) {
      ...
      trendsByBiomarker["HDL"].data.push({ date: dateStr, value: hr.hdl_cholesterol, isAbnormal: false, labName })
    }
    if (hr.triglycerides !== null) {
      ...
      trendsByBiomarker["TRIGLYCERIDES"].data.push({ date: dateStr, value: hr.triglycerides, isAbnormal: false, labName })
    }
    if (hr.vitamin_d !== null) {
      ...
      trendsByBiomarker["VITAMIN_D"].data.push({ date: dateStr, value: hr.vitamin_d, isAbnormal: false, labName })
    }
    if (hr.vitamin_b12 !== null) {
      ...
      trendsByBiomarker["VITAMIN_B12"].data.push({ date: dateStr, value: hr.vitamin_b12, isAbnormal: false, labName })
    }
  })
